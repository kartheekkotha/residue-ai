...
- When the user defers something ("I'll check later", "remind me", "let's come back to this", "waiting for results", "running a build"), silently call `add_task_tool`. Do NOT announce it.
